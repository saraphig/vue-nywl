  ...
  <div class="area">
    <div class="area-box">
      ...
      <div class="area-content">
        ...
        <sh-row class="sh-form sh-from-font5 area-form" :gutter="0" >
           <sh-table :columns="columns" :data="tdatas" @pageChange="pageChange" :operate="false">
            </sh-table>
        </sh-row>
        <div class="area-group-title">位置信息</div>
        <sh-row class="sh-form sh-from-font5 view-left" :gutter="20">
          <sh-col :span="12" class="sh-from-font7">
            <label class="sh-form-label ">所在机构名称:</label>
            <div class="sh-form-text">
              <sh-textbox v-model="institutionsname" :disabled='true'></sh-textbox>
            </div>
          </sh-col>
          <sh-col :span="12" class="sh-from-font7">
            <label class="sh-form-label">所在地块编号:</label>
            <div class="sh-form-text">
              <sh-textbox v-model="aeraId" :disabled='true'></sh-textbox>
            </div>
          </sh-col>
          <sh-col :span="12" class="sh-from-font7">
            <label class="sh-form-label">所在地块名称:</label>
            <div class="sh-form-text">
              <sh-textbox v-model="areaname" :disabled='true'></sh-textbox>
            </div>
          </sh-col>
          <sh-col :span="24" class="sh-from-font8 view-img-title">
            <label class="sh-form-label ">二维平面位置信息</label>
          </sh-col>
          <sh-col :span="24" class="sh-from-font7 view-img-left">
            <div class="img-show">
              <p>暂无图片</p>
            </div>
          </sh-col>
...
.view-img-title{margin-left:12px;}
</style>