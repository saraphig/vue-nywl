    ...
    <div class="area-box">
      <div class="area-header">
        <div class="area-header-box">
          <div class="area-header-title">新增地块</div>
      ...
      <div class="area-content">
        ...
        <sh-row class="sh-form area-add-form sh-from-font7"
          :gutter="20">
          <sh-col :span="12">
          ...
          <sh-col :span="12">
            ...
            <div class="sh-form-text">
              <sh-input v-model="typeDescription"
                placeholder="请输入种/养殖描述"></sh-input>
            </div>
          </sh-col>
          <sh-col :span="12">
        ...
        <sh-row class="sh-form sh-from-font7 area-add-form"
          :gutter="20">
          <sh-col :span="24">
            <label class="sh-form-label">
  ...
  methods: {
    ...
    save() {
      ...
      let sendModel = {
        ...
        parentId: this.organizationEntity.id
      };
      this.$store.dispatch("addAreaInfo", sendModel).then(
        data => {
