<template>
  <div class="slde-wrap">
      ...
      <div class="sidebar-main">
        <ul class="sidebar-menu">
          <template v-for="(item ,index) in menulist">
            <li :class="currentUrl === item.menuUrl || index  == nowIndex ? 'active':''">
    ...
    <v-messagebox v-show="show"  @select-type="onSelectType" @sureHandel="sureHandel"  ></v-messagebox>
  </div>
</template>
<script>
...
//          },
    ...
    created: function () {
      this.currentUrl =this.menulist[0].children[0].menuUrl;
      this.$nextTick(() => {
