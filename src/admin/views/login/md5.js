 ...
 */
export const hex_md5 = s => { return binl2hex(core_md5(str2binl(s), s.length * chrsz));}
export const b64_md5 = s => { return binl2b64(core_md5(str2binl(s), s.length * chrsz));}
export const str_md5 = s => { return binl2str(core_md5(str2binl(s), s.length * chrsz));}
export const hex_hmac_md5 = (key, data) => { return binl2hex(core_hmac_md5(key, data)); }
export const b64_hmac_md5 = (key, data) => { return binl2b64(core_hmac_md5(key, data)); }
export const str_hmac_md5 = (key, data) => { return binl2str(core_hmac_md5(key, data)); }
