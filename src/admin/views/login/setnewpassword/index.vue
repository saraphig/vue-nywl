<template>
  <div class="forget-password-bg">
    ...
    <img class="forget-password-img" src="../../../assets/img/login/forget-password-step3.png"/>
    ...
    <button class="finish-button" @click="finish" name="set-new-password-finish-button">完成</button>
  </div>
</template>
