<template>
    <table class="sh-month-table">
        <tr v-for="(row,index) in rows"
            :key="index">
            <td :class="{
                'sh-month-table--select':isSelected(index * rows.length + monthIndex),
                'sh-month-table--disabled':isDisabled(index * rows.length + monthIndex),
                }"
