        ...
        var t = (function() {
                ...
                var n = "100%",
                    ...
                    a = {
                        ...
                        szColorProperty: "",
                        szOcxClassId:
                            "clsid:FDF0038A-CF64-4634-81AB-80F0A7946D6C",
                ...
                (e.GetSelectWndInfo = function(e) {
                    ...
                    (e.ZoomInfoCallback = function(e) {
                        ...
                        if (-1 != t) {
                            var s = p[t];
                            if (
                                ((t = f.findDeviceIndexByIP(s.szIP)), -1 != t)
                            ) {
                                var n = l[t];
                    ...
                    (e.GetHttpInfo = function(e, t, s) {
                        Z("http响应返回：http状态：%s, http数据：%s", e, t),
                            te.prototype.processCallback(e, t);
                    });
                var Z = function() {
                        if (a.bDebugMode) {
                            var e = k(arguments);
                    ...
                    _ = function() {
                        ...
                        if (I.browser().msie)
                            ...
                            for (
                                var t = navigator.mimeTypes.length, s = 0;
                                t > s;
                                s++
                            )
                    ...
                    F = function(e) {
                        var t = -1,
                            ...
                            r = null;
                        if (j(e))
                            (r = U(e)), (t = r.iRtspPort), (n = r.iDevicePort);
                        else {
                            ...
                            e.oProtocolInc.getNetworkBond(e, {
                                ...
                                success: function(n) {
                                    ...
                                    s
                                        ...
                                        : e.oProtocolInc.getNetworkInterface(
                                              e,
                                              {
                                                  async: !1,
                                                  success: function(e) {
                    ...
                    j = function(e) {
                        ...
                        return (
                            e.oProtocolInc.getPPPoEStatus(e, {
                                ...
                                success: function(e) {
                                    t =
                                        s.$XML(e).find("ipAddress", !0).length >
                                        0
                                            ? !0
                                            : s.$XML(e).find("ipv6Address", !0)
                                                  .length > 0;
                                },
                                error: function() {
                                    t = !1;
                ...
                (this.I_Login = function(e, t, s, n, r, o) {
                    ...
                    (this.I_StartRealPlay = function(e, t) {
                        ...
                        if ((I.extend(h, t), -1 != n)) {
                            ...
                            if (
                                ...
                                -1 == n &&
                                    (r = f.oProtocolInc.startRealPlay(f, h)),
                                -1 == r)
                            )
                                f.iRtspPort = -1;
                            else {
                    ...
                    (this.I_StopVoiceTalk = function() {
                        for (
                            var e = u.HWP_StopVoiceTalk(), t = 0, s = l.length;
                            s > t;
                            t++
                        )
                            if (l[t].bVoiceTalk) {
                    ...
                    (this.I_PTZControl = function(e, t, s) {
                        var n = { iWndIndex: c, iPTZIndex: e, iPTZSpeed: 4 };
                        I.extend(n, s), I.extend(n, { async: !1 });
                        var r = this.findWndIndexByIndex(n.iWndIndex);
                        if (-1 != r) {
                            var o = p[r];
                            if (
                                ((r = this.findDeviceIndexByIP(o.szIP)),
                                -1 != r)
                            ) {
                                var i = l[r];
                                9 == e
                    ...
                    (this.I_DisableEZoom = function(e) {
                        ...
                        if (-1 != t) {
                            var n = p[t];
                            if (n.bEZoom)
                                return u.HWP_DisableZoom(e), (n.bEZoom = !1), 0;
                        }
                        return s;
                    }),
                    ...
                    (this.I_Disable3DZoom = function(e) {
                        ...
                        if (-1 != t) {
                            ...
                            if (n.b3DZoom)
                                return (
                                    u.HWP_DisableZoom(e), (n.b3DZoom = !1), 0
                                );
                        }
                        return s;
                    }),
                    ...
                    (this.I_SetPreset = function(e, t) {
                        var s = { iWndIndex: c, iPresetID: e };
                        I.extend(s, t);
                        var n = this.findWndIndexByIndex(s.iWndIndex);
                        if (-1 != n) {
                            var r = p[n];
                            if (
                                ((n = this.findDeviceIndexByIP(r.szIP)),
                                -1 != n)
                            ) {
                                var o = l[n];
                    ...
                    (this.I_CheckPluginInstall = function() {
                        ...
                        if (t.msie)
                            ...
                            for (
                                var n = 0, r = navigator.mimeTypes.length;
                                r > n;
                                n++
                            )
                                if (
                                    "application/webvideo-plugin-kit" ==
                                    navigator.mimeTypes[n].type.toLowerCase()
                                ) {
                                    e = 0;
                                    break;
                                }
                ...
                (te.prototype.m_httpRequestSet = []),
                    (te.prototype.setRequestParam = function(e) {
                    ...
                    (te.prototype.submitRequest = function() {
                        ...
                        if (this.options.async) {
                            ...
                            var n = u.HWP_SendHttpSynRequest(
                                e,
                                this.options.url,
                                this.options.auth,
                                this.options.data,
                    ...
                    (te.prototype.processCallback = function(e, t) {
                        for (
                            var s = null, n = 0;
                            n < this.m_httpRequestSet.length;
                            n++
                        )
                ...
                (se.prototype.CGI = {
                    ...
                    getAnalogChannelInfo:
                        "%s%s:%s/ISAPI/System/Video/inputs/channels",
                    getDigitalChannel:
                        "%s%s:%s/ISAPI/ContentMgmt/InputProxy/channels",
                    getDigitalChannelInfo:
                        "%s%s:%s/ISAPI/ContentMgmt/InputProxy/channels/status",
                    getZeroChannelInfo:
                        "%s%s:%s/ISAPI/ContentMgmt/ZeroVideo/channels",
                    getStreamChannels: {
                        analog: "%s%s:%s/ISAPI/Streaming/channels",
                        digital:
                            "%s%s:%s/ISAPI/ContentMgmt/StreamingProxy/channels"
                    },
                    ...
                    startVoiceTalk: {
                        open:
                            "%s%s:%s/ISAPI/System/TwoWayAudio/channels/%s/open",
                        close:
                            "%s%s:%s/ISAPI/System/TwoWayAudio/channels/%s/close",
                        audioData:
                            "%s%s:%s/ISAPI/System/TwoWayAudio/channels/%s/audioData"
                    },
                    ptzControl: {
                    ...
                    ptzAutoControl: {
                        ipdome:
                            "%s%s:%s/ISAPI/PTZCtrl/channels/%s/presets/%s/goto",
                    ...
                    ptzFocus: {
                        ...
                        digital:
                            "%s%s:%s/ISAPI/ContentMgmt/ImageProxy/channels/%s/focus",
                        ipc:
                            "%s%s:%s/ISAPI/System/Video/inputs/channels/%s/focus"
                    },
                    ptzIris: {
                        analog: "%s%s:%s/ISAPI/Image/channels/%s/iris",
                        digital:
                            "%s%s:%s/ISAPI/ContentMgmt/ImageProxy/channels/%s/iris",
                        ipc:
                            "%s%s:%s/ISAPI/System/Video/inputs/channels/%s/iris"
                    },
                    getNetworkBond: "%s%s:%s/ISAPI/System/Network/Bond",
                    getNetworkInterface:
                        "%s%s:%s/ISAPI/System/Network/interfaces",
                    getUPnPPortStatus:
                        "%s%s:%s/ISAPI/System/Network/UPnP/ports/status",
                    getPPPoEStatus:
                        "%s%s:%s/ISAPI/System/Network/PPPoE/1/status",
                    ...
                    startShttpReversePlayback:
                        "%s%s:%s/SDK/playback/%s/reversePlay",
                    startTransCodePlayback:
                        "%s%s:%s/SDK/playback/%s/transcoding",
                    ...
                    (se.prototype.ptzAutoControl = function(e, t, s, n) {
                        ...
                        if (
                            ((n.iPTZSpeed =
                                n.iPTZSpeed < 7 ? 15 * n.iPTZSpeed : 100),
                            t && (n.iPTZSpeed = 0),
                            e.szDeviceType != X)
                        )
                            (o =
                    ...
                    (se.prototype.ptzControl = function(e, t, s, n) {
                        var r = s.iChannelID,
                            o = "";
                        s.bPTZAuto &&
                            this.ptzAutoControl(e, !0, s, { iPTZSpeed: 0 }),
                            t
                                ? (n.iPTZSpeed = 0)
                                : (n.iPTZSpeed =
                                      n.iPTZSpeed < 7 ? 15 * n.iPTZSpeed : 100);
                        ...
                        o =
                            (u != this.CGI.ptzFocus && u != this.CGI.ptzIris) ||
                            (e.szDeviceType != G &&
                                e.szDeviceType != X &&
                                e.szDeviceType != H)
                                ? r <= e.iAnalogChannelNum
                    ...
                    (se.prototype.importDeviceConfig = function(e, t) {
                        ...
                        return u.HWP_ImportDeviceConfig(
                            s,
                            e.szAuth,
                            t.szFileName,
                            0
                ...
                (ne.prototype.CGI = {
                    ...
                    getAudioInfo:
                        "%s%s:%s/PSIA/Custom/SelfExt/TwoWayAudio/channels",
                    getDeviceInfo: "%s%s:%s/PSIA/System/deviceInfo",
                    getAnalogChannelInfo:
                        "%s%s:%s/PSIA/System/Video/inputs/channels",
                    getDigitalChannel:
                    ...
                    startVoiceTalk: {
                        open:
                            "%s%s:%s/PSIA/Custom/SelfExt/TwoWayAudio/channels/%s/open",
                        close:
                            "%s%s:%s/PSIA/Custom/SelfExt/TwoWayAudio/channels/%s/close",
                        audioData:
                            "%s%s:%s/PSIA/Custom/SelfExt/TwoWayAudio/channels/%s/audioData"
                    },
                    ptzControl: "%s%s:%s/PSIA/PTZ/channels/%s/continuous",
                    ptzAutoControl:
                        "%s%s:%s/PSIA/Custom/SelfExt/PTZ/channels/%s/autoptz",
                    setPreset: "%s%s:%s/PSIA/PTZ/channels/%s/presets/%s",
                    goPreset: "%s%s:%s/PSIA/PTZ/channels/%s/presets/%s/goto",
                    ptzFocus:
                        "%s%s:%s/PSIA/System/Video/inputs/channels/%s/focus",
                    ptzIris:
                        "%s%s:%s/PSIA/System/Video/inputs/channels/%s/iris",
                    getNetworkBond: "%s%s:%s/PSIA/Custom/SelfExt/Bond",
                    getNetworkInterface:
                        "%s%s:%s/PSIA/System/Network/interfaces",
                    getUPnPPortStatus:
                        "%s%s:%s/PSIA/Custom/SelfExt/UPnP/ports/status",
                    getPPPoEStatus:
                        "%s%s:%s/PSIA/Custom/SelfExt/PPPoE/1/status",
                    ...
                    set3DZoom:
                        "%s%s:%s/PSIA/Custom/SelfExt/PTZ/channels/%s/Set3DZoom"
                }),
                ...
                (re.prototype._alert = function(e) {
                    ...
                    (function(t) {
                        ...
                        (s.prototype.find = function(e, t) {
                            ...
                            return (
                                (this.length = this.elems.push(s)), t ? s : this
                            );
                        }),
                    ...
                    (oe.prototype.Base64 = {
                        ...
                        encode: function(e) {
                            var t,
                                ...
                                c = 0;
                            for (
                                e = oe.prototype.Base64._utf8_encode(e);
                                c < e.length;
